...
function Fundraising() {
  ...
  const fundRaiseData = kpiData.fundraising;
  // const fundRaiseData = [
  //   {
  ...
  return (
    <FundraisingFormWrapper>
      {fundRaiseData?.map(({ description, label }, idx) => (
        <FundraisingWrapper key={idx}>
          <FundraisingContainer>
            <div className="text-container">
              <FundraisingHeader>{label}</FundraisingHeader>
              <FundraisingText>{description}</FundraisingText>
            </div>
