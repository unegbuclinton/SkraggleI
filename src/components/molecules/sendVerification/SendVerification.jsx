    ...
    <VerificationWrapper>
        <div className='send-verification'>
            ...
            <p className='send-verification__info'>
                To complete the sign up and log in, click the
                verification link in the email we have sent to
            </p>
           
           <div className='send-verification__email'>
           john@example.com
           </div>

           <p className='send-verification__link'>
