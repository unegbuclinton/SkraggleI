    ...
    <WarningWrapper>
      <Card className="warning-card">
        ...
        <p className="warning-text">
          We are sorry to see you go! Could you please let us know what we can do better next time?
        </p>
        ...
        <UnsubscribeField>
          ...
          <textarea name="text" id="feeback-field">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia unde natus eligendi. Alias
            harum expedita fuga libero. Dignissimos minima eligendi delectus qui. Obcaecati eos
            incidunt numquam fugit consequatur itaque sequi, beatae omnis, similique, quod eius
            voluptatibus animi culpa eveniet alias dolores. Sit expedita aliquam natus odit nisi
            adipisci dolore magni!
          </textarea>
        </UnsubscribeField>
